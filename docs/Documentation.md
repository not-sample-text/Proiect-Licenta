...
> **Note on sleep:** All GPIOs support interrupts and light-sleep wake. Only RTC-capable GPIOs (0–21) can wake from deep sleep. The column pins (35–37) and BT_SELECT (34) are _not_ RTC GPIOs; for deep-sleep wake, drive columns high and use the row pins as wake sources.
